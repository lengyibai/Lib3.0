...
const __pageData = JSON.parse('{"title":"$strDelReps","description":"","frontmatter":{},"headers":[],"relativePath":"Functions/ordinary/StrDelReps.md","lastUpdated":1666717310000}');
const _sfc_main = { name: "Functions/ordinary/StrDelReps.md" };
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(_attrs)}><h1 id="strdelreps" tabindex="-1">$strDelReps <a class="header-anchor" href="#strdelreps" aria-hidden="true">#</a></h1>`);
  _push(ssrRenderComponent(_component_ContainerBox, { title: "\u4ECB\u7ECD" }, {
    desc: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        return [
          createTextVNode(" \u53BB\u6389\u5B57\u7B26\u4E32\u8FDE\u7EED\u91CD\u590D\u7684\u5B57\u7B26 ")
        ];
      }
    }),
    _: 1
  }, _parent));
  _push(ssrRenderComponent(_component_ContainerBox, { title: "\u8FDE\u7EED" }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(` \`\`\`js $strDelRep(&#39;1233211234567&#39;); //&#39;1234567&#39; \`\`\` `);
...
<span class="line"${_scopeId2}></span></code></pre></div>`);
        ...
        return [
          createTextVNode(" ```js $strDelRep('1233211234567'); //'1234567' ``` "),
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("Functions/ordinary/StrDelReps.md");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const StrDelReps = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);
export {
  __pageData,
  StrDelReps as default
};
