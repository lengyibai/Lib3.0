...
const __pageData = JSON.parse('{"title":"$isPhone","description":"","frontmatter":{},"headers":[],"relativePath":"Functions/ordinary/IsPhone.md","lastUpdated":1666717310000}');
const _sfc_main = { name: "Functions/ordinary/IsPhone.md" };
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(_attrs)}><h1 id="isphone" tabindex="-1">$isPhone <a class="header-anchor" href="#isphone" aria-hidden="true">#</a></h1>`);
  ...
  _push(ssrRenderComponent(_component_ContainerBox, { title: "\u57FA\u7840\u7528\u6CD5" }, {
    desc: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<p${_scopeId}>\u8FD4\u56DE<code${_scopeId}>Boolean</code>\u503C</p><div class="language-js"${_scopeId}><button class="copy"${_scopeId}></button><span class="lang"${_scopeId}>js</span><pre${_scopeId}><code${_scopeId}><span class="line"${_scopeId}><span style="${ssrRenderStyle({ "color": "#82AAFF" })}"${_scopeId}>$isPhone</span><span style="${ssrRenderStyle({ "color": "#A6ACCD" })}"${_scopeId}>()</span><span style="${ssrRenderStyle({ "color": "#89DDFF" })}"${_scopeId}>;</span></span>
            ...
            createVNode("pre", null, [
              createVNode("code", null, [
                createVNode("span", { class: "line" }, [
                  createVNode("span", { style: { "color": "#82AAFF" } }, "$isPhone"),
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("Functions/ordinary/IsPhone.md");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const IsPhone = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);
export {
  __pageData,
  IsPhone as default
};
