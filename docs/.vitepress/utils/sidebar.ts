  ...
  '/Components/': [
    ...
    },
    {
      ...
      items: [
        ...
        { text: '获取验证码按钮', link: '/Components/dynamics/ValidationCountdown' },
      ],
    },
  ],
  '/Styles/': [
  ...
  '/Functions/': [
    {
      ...
      items: [
        ...
        { text: '获取浏览器谷歌内核版本', link: '/Functions/ordinary/ChromeV' },
    ...
    },
    {
      ...
      items: [
        ...
        { text: '复制到剪切板', link: '/Functions/custom/Copy' },
        ...
        { text: '记录已过去精确时间或倒计时', link: '/Functions/custom/TimeCount' },
        { text: '中文转拼音', link: '/Functions/custom/Pinyin' },
        { text: '正则搜索', link: '/Functions/custom/Search' },
        { text: '判断是否为指定类型的文件链接', link: '/Functions/custom/UrlFileType' },
        ...
        { text: '秒数格式化', link: '/Functions/custom/FmtSec' },
